		...
		public function __toString(){
			...
			echo '<html lang="en">';
				echo '<head>';
					...
					echo '<link rel="stylesheet" type="text/css" href="./src/Resources/jQuery/Addons/Bootstrap/v4.3.1/css/bootstrap.css" media="all">';
					echo '<link rel="stylesheet" type="text/css" href="./src/Resources/Styles/Standard/CSS/master.css" media="all">';
				echo '</head>';
