<?php
	...
	class MailSys{
		...
		# Public Methods
		public function __construct($db,$Setting,$User){
			$this->db			=	$db;
		...
		function MAILSYS_STATUS(){
			$this->ENABLED = $this->_do_query("SETTINGS_MAIN","MAILSYS_ENABLE",1);
		}
		...
		function PHPMAILER_ACCOUNT_ID(){
			return $this->_do_query("SETTINGS_MAIN","PHPMAILER_ACCOUNT_ID",0);
		}
		function PHPMAILER_ACCOUNT_PW(){
			return $this->_do_query("SETTINGS_MAIN","PHPMMAILER_ACCOUNT_PW",0);
		}
		function PHPMAILER_REPLY_NAME(){
			return $this->_do_query("SETTINGS_MAIN","PHPMAILER_REPLY_NAME",0);
		}
		function PHPMAILER_REPLY_EMAIL(){
			return $this->_do_query("SETTINGS_MAIN","PHPMAILER_REPLY_EMAIL",0);
		}
		function PHPMAILER_HOST(){
			$this->PHPMAILER_HOST = $this->_do_query("SETTINGS_MAIN","PHPMAILER_HOST",1);
...
#			$mail->MsgHTML($this->MSG_CONTENT);
		...
		function messages($MsgType,$RegInfo){
			if($MsgType === 0){
				...
				$this->MSG_CONTENT	.=	'Your SecurID is: '.$RegInfo[12].'.<br><br>';
				...
				$this->MSG_CONTENT	.=	'To complete your registration and activate your account, click <a href="'.$RegInfo[14].'">here</a>.<br>';
				$this->MSG_CONTENT	.=	'If you can\'t click the above link, simply copy and paste the following link into your address bar.<br>';
				$this->MSG_CONTENT	.=	$RegInfo[14].'<br><br>';
