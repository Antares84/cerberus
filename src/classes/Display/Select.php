<?php
	...
	class Select{
		public function _get($Type){
			...
			echo '<b>Class ('.get_class($this).'):</b> Defined selector not found';
		}

		# Registration
		private function _get_dobm(){
		...
		private function _get_sec_question(){
			$secArr = array(
		...
		private function _get_pane_bg_trans(){
			echo '<select class="form-control" id="VALUE" name="VALUE">';
		...
		private function _get_site_type(){
			echo '<select class="form-control tac" name="VALUE">';
				echo '<option disabled selected>Site Type*</option>';
				echo '<option value="STD">Standard</option>';
				echo '<option value="BDSM">BDSM</option>';
				echo '<option value="MUSIC">Music Host</option>';
				echo '<option value="SH">Shaiya</option>';
				echo '<option value="FORTE">Forte</option>';
				echo '<option value="JV">JV</option>';
				echo '<option value="EVE">EVE Online</option>';
			echo '</select>';
		}

		# Plugins
		private function _get_plugin_order(){
		...
		private function _get_plugin_enable(){
		...
		# Settings
		private function _get_sidebar_pos(){
		...
		# Paging
		private function _get_page_show(){
		...
		private function _get_req_login(){
		...
		# FTW
		private function _get_warr_opt(){
			echo "<div id=\"name-group\" class=\"form-group\" ng-class=\"{ 'has-error' : errormot_warr_opt }\">";
				echo "<label class=\"col-md-4 control-label tar mtb_8_0\">Warranty Options *</label>";
				echo "<div class=\"col-md-4 selectContainer\">";
					echo "<div class=\"input-group\">";
						echo "<span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-list\"></i></span>";
						echo "<select name=\"mot_warr_opt\" class=\"form-control selectpicker\" ng-model=\"formData.mot_warr_opt\">";
							echo "<option value=\"\" selected=\"selected\">Select Warranty</option>";
							echo "<option value=\"1\">1-Year Factory Warranty</option>";
							echo "<option value=\"2\">2-Year Factory Warranty</option>";
							echo "<option value=\"3\">3-Year Factory Warranty</option>";
							echo "<option value=\"4\">4-Year Factory Warranty</option>";
							echo "<option value=\"5\">5-year Factory Warranty</option>";
						echo "</select>";
					echo "</div>";
					echo "<span class=\"help-block\" ng-show=\"errormot_warr_opt\">{{ errormot_warr_opt }}</span>";
				echo "</div>";
			echo "</div>";
			echo "<div class=\"field_separator\"></div>";
		}
		private function _get_states(){
			echo "<div id=\"name-group\" class=\"form-group\" ng-class=\"{ 'has-error' : errorstate }\">";
				echo "<label class=\"col-md-4 control-label tar mtb_8_0\">State *</label>";
				echo "<div class=\"col-md-4 selectContainer\">";
					echo "<div class=\"input-group\">";
						echo "<span class=\"input-group-addon\"><i class=\"glyphicon glyphicon-map-marker\"></i></span>";
						echo "<select name=\"state\" class=\"form-control selectpicker\" ng-model=\"formData.state\">";
							echo "<option value=\"\" selected=\"selected\">Please Select Your State</option>";
						...
						echo "</select>";
					echo "</div>";
					echo "<span class=\"help-block\" ng-show=\"errorstate\">{{ errorstate }}</span>";
				echo "</div>";
			echo "</div>";
			echo "<div class=\"field_separator\"></div>";
		}
		# Shaiya
		private function _get_acct_ban(){
