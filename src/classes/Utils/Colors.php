<?php
	...
	#############################################################################################
	#	Title: Colors.class.php																	#
	#	Author: Bradley Sweeten																	#
	#	Rel: CMS Colors class, used for loading all colors resources							#
	#	Last Update Date: 04.27.2019	0306													#
	#############################################################################################

	class Colors{

		private $Alpha=false;private $BGColor=false;private $Color=false;private $ColorType=false;private $Hex=false;private $RGB=false;private $Type=false;

		# Public Methods
		public function __construct($db){
			$this->db	=	$db;
		}
		public function _do_ColorBuilder($Type,$Color='',$Alpha='',$Text=''){
			$return=false;

			if(empty($Type)){
				throw new SystemException('[Type] must be defined! Check your code and try again.',0,0,__FILE__,__LINE__);
			}
			else{$this->Type=$Type;}

			if(empty($Color)){
				throw new SystemException('Color is either undefined or null. A color must be defined!',0,0,__FILE__,__LINE__);
			}
			...
			elseif($this->Type == 'span'){
				$this->ColorType	=	'HEX';
				$this->Hex			=	$this->_do_db_colors($this->Color);
				$return				=	'<span style="color:#'.$this->Hex.' !important;">'.$Text.'</span>';
			}
		...
		public function _colors_default($type,$color){
			$default	=	'';

			if(is_numeric($color)){
				switch($color){
					# Badge Colors
					case	0	:	$default='badge-primary';	break;
					case	2	:	$default='badge-secondary';	break;
					case	3	:	$default='badge-success';	break;
					case	4	:	$default='badge-danger';	break;
					case	5	:	$default='badge-warning';	break;
					case	6	:	$default='badge-info';		break;
					case	7	:	$default='badge-light';		break;
					case	8	:	$default='badge-dark';		break;

					# Background Colors
					case	9	:	$default='bg-primary';		break;
					case	10	:	$default='bg-secondary';	break;
					case	11	:	$default='bg-success';		break;
					case	12	:	$default='bg-danger';		break;
					case	13	:	$default='bg-warning';		break;
					case	14	:	$default='bg-info';			break;
					case	15	:	$default='bg-light';		break;
					case	16	:	$default='bg-dark';			break;
					case	17	:	$default='bg-white';		break;
					case	18	:	$default='bg-black';		break;
					case	18	:	$default='bg-grey black';	break;
				}
			}

			if($default == '' || !$default==$color){
				if($type==''){
					throw new SystemException('<b>'.get_class($this).'</b>: [Type] must be defined! Check your code and try again.',0,0,__FILE__,__LINE__);
				}else{
					return $this->_do_ColorBuilder($type,$color);
				}
			}
		...
		private function _do_db_colors(){
			$sql	=	('
							SELECT TOP 1 *
