	...
	class BossRecord{
		...
		function get_Record(){
			echo '<div class="table-responsive">';
				echo '<table class="table table-sm table-striped acp_table tac">';
					echo '<thead>';
						echo '<tr class="boss-record">';
							echo '<th class="boss-record"><center>Boss</center></th>';
							echo '<th class="boss-record"><center>Killed by</center></th>';
							echo '<th class="boss-record"><center>Respawns in</center></th>';
						echo '</tr>';
					echo '</thead>';
					...
					foreach($this->MobID as $value){
						...
						if($this->MobName != NULL){
							$this->get_BossRespawnTime($value);
		...
		function get_BossRespawnTime($value){
			# WHEN YOU ADD A MOB REMEMBER TO ADD THE TIME
			switch($value){
				case 2839	:	$hours = 12;	break;	# LUMEN
				case 2785	:	$hours = 12;	break;	# ALES
				case 2821	:	$hours = 12;	break;	# SECRETA
				case 2803	:	$hours = 12;	break;	# DENTATUS
				case 3010	:	$hours = 12;	break;	# Cryptic Bulldozer
				case 3040	:	$hours = 12;	break;	# Cryptic Back
				case 3041	:	$hours = 16;	break;	# Cryptic The Immortal
				case 3042	:	$hours = 12;	break;	# Cryptic The Last
				...
				case 1259	:	$hours = 10;	break;	# Greendieta Seraphim
