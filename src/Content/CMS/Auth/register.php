<?php
	echo '<div class="card no_bg no_border no_radius">';
		echo '<div class="card-header card_border tac title pTitle show no_radius">'.$this->Setting->_arr["SITE_TITLE"].' Registration</div>';
			...
			echo '<div class="card-text">';
				echo '<div class="container">';
					...
					if($this->MailSys->ENABLED){
						...
						echo '<div class="form-group row">';
							echo '<div class="col-sm-12 tac">';
								echo '<div class="badge badge-dark tac w_100_p f_18">Account</div>';
							echo '</div>';
						echo '</div>';
						...
						echo '<div class="form-group row">';
							echo '<div class="col-md-4 hidden-sm-down"></div>';
							echo '<div class="col-md-4 col-sm-12">';
								echo $this->Select->_get_select('gender');
							echo '</div>';
						echo '</div>';
						...
						echo '<div class="form-group row">';
							echo '<div class="col-md-4 hidden-sm-down"></div>';
							echo '<div class="col-md-4 col-sm-12">';
								echo $this->Select->_get_select('sec_question');
							echo '</div>';
						echo '</div>';
						...
						echo '<div class="form-group row">';
							...
							echo '<div class="col-md-4 col-sm-12">';
								echo '<center>';
									echo '<input name="Checkbox" type="radio"/> I Agree to the <a href="?'.$this->Setting->_arr["PAGE_PREFIX"].'=ToS" target="_blank">'.$this->Setting->_arr["SITE_TITLE"].' Terms Of Use</a>';
								echo '</center>';
							echo '</div>';
						echo '</div>';
