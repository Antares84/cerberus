<?php
	...
	$this->Modal->Display($this->PageZone,'settings_modal','<i class="fa fa-pencil"></i>','0','2','Edit Setting');
	$this->Modal->Display($this->PageZone,'lock_modal','<i class="fa fa-pencil"></i>','0','2','Lock Setting');
	$this->Modal->Display($this->PageZone,'unlock_modal','<i class="fa fa-pencil"></i>','0','2','Un-lock Setting');
?>
<script>
