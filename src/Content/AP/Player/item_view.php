<?php
	...
	if(isset($_POST['submit']) || strlen($CharName) > 1){
		...
		if(!$SH_CHARITEMS->readItems($this->Setting->_stng_array[15])){
			$this->Tpl->Titlebar('View Player\'s Equipped Items: '.$CharName,'w_100_p');
			echo '<div class="row">';
				echo '<div class="col-lg-12">';
			...
			$this->Tpl->Titlebar('Current Links In Equipped Gear Of: '.$CharName,'w_100_p');
			echo '<div class="row">';
				echo '<div class="col-lg-12">';
					echo '<div id="sb_content">';
						$SH_CHARITEMS->getLapis($this->Setting->_stng_array[15]);
						$retObj	=	$SH_CHARITEMS->readItems($this->Setting->_stng_array[15]);
...
#										echo '<td>'.$retObj[$i]["ItemUID"].'</td>';
		...
		$this->Tpl->Titlebar('View Gear Links of Character','w_100_p');
		echo '<div class="row">';
			echo '<div class="col-lg-12">';
				echo '<div id="sb_content">';
