<?php
	...
	$PHP=new PHP();$Parser=new Parser();$db=new Database();$Browser=new Browser();$Dirs=new Dirs();$PvP=new PvP();$Select=new Select();
	...
	# Load Content
	$Content=new Content($BossRecord,$Browser,$Colors,$Data,$db,$Dirs,$Donate,$LogSys,$MailSys,$Messenger,$Modal,$Nav,$Notices,$Paging,$PayPal,$PHP,$Plugins,$PvP,$Read,$Select,$Session,$Setting,$ShChar,$ShUser,$SQL,$Style,$Tbl,$Template,$Theme,$User,$Version,$Wow);
	# Display
