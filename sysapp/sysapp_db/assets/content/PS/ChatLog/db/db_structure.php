...
CREATE DATABASE [PS_ChatLog]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PS_ChatLog_Data', FILENAME = N'Database Folder Location\PS_ChatLog.mdf' , SIZE = 2560KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'PS_ChatLog_Log', FILENAME = N'Database Folder Location\PS_ChatLog.ldf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
GO
