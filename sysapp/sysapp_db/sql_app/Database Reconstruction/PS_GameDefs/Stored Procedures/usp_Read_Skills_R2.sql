...
/****** Object:  StoredProcedure [dbo].[usp_Read_Skills_R2]    Script Date: 8/14/2014 10:48:56 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE  Proc [dbo].[usp_Read_Skills_R2]
...
AddDamageHP, AddDamageSP, AddDamageMP, AbilityType1, AbilityValue1, AbilityType2, AbilityValue2, AbilityType3, AbilityValue3, HealHP, HealSP, HealMP, TimeHealHP, TimeHealSP, TimeHealMP, 
DefenceType, DefenceValue, LimitHP, FixRange, ChangeType, ChangeLevel
FROM Skills
WHERE SkillID = @SkillID AND SkillLevel = @SkillLevel
