...
/******
File Label: Trigger [dbo].[Commands]
Script Date: 8/14/2014 10:23:07 PM
******/
SET ANSI_NULLS ON
GO
...
-- Add AP to all accounts.
-- Note: Must be ADM on the server to use this command.
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
			...
			UPDATE PS_GameData.dbo.Chars SET RemainTime = 0		WHERE CharName = @Char 
			UPDATE PS_GameData.dbo.Chars SET DeleteDate = ''	WHERE CharName = @Char 
        END
    END
END
