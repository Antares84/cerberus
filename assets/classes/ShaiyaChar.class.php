					...
					echo '<table class="table table-sm table-bordered table-inverse acp_table text-center">';
						...
						while($data = odbc_fetch_array($stmt)){
							echo '<tr>';
								...
								echo '<td><a href="?'.$this->Setting->PAGE_PREFIX.'=PLR_SEARCH&CharID='.$data['CharID'].'&CharName='.$data['CharName'].'" target="_blank">'.$data['CharName'].'</a></td>';
					...
					if(!odbc_num_rows($stmt)){
						echo '<div id="sb_content">';
							echo '<form action="" method="post">';
								...
								echo '<div class="form-group btn_center">';
									echo '<a class="badge badge-pill badge-primary" href="?'.$this->Setting->PAGE_PREFIX.'=Search" />Try Again</a>';
								echo '</div>';
							echo '</form>';
						echo '</div>';
					}
						...
						echo '<div id="sb_content">';
								...
								echo '<table class="table table-sm table-bordered table-inverse acp_table text-center">';
									...
									while($data = odbc_fetch_array($stmt)){
										echo '<tr>';
											...
											echo '<td>'.$data['Level'].'</td>';
											echo '<td><a class="badge badge-pill badge-primary m_t_5" target="_blank" href="?'.$this->Setting->PAGE_PREFIX.'=PLR_BUFF_VIEW&CharName='.$CharName.'&CharID='.$data["CharID"].'" target="_blank">Go</a></td>';
											echo '<td><a class="badge badge-pill badge-primary m_t_5" target="_blank" href="?'.$this->Setting->PAGE_PREFIX.'=PLR_ITEM_VIEW&CharName='.$CharName.'&CharID='.$data["CharID"].'" target="_blank">Go</a></td>';
											echo '<td><a class="badge badge-pill badge-primary m_t_5" target="_blank" href="?'.$this->Setting->PAGE_PREFIX.'=PLR_STATS_EDITOR&CharName='.$CharName.'&CharID='.$data["CharID"].'" target="_blank">Go</a></td>';
										echo '</tr>';
									}
									echo '<tbody>';
								echo '</table>';
							...
							echo '<div class="text-center f_20 p_b_15">';
								echo '<a class="badge badge-primary" href="?'.$this->Setting->PAGE_PREFIX.'=PLR_SEARCH">New Search <i class="fa fa-search"></i></a>';
							echo '</div>';
						echo '</div>';
					}
				}
