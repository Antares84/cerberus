<?php
	require_once($this->Plugins->get_PLUGINS_DIR().'PHPMailer/PHPMailerAutoload.php');

	if(isset($_POST['submit'])){
		$Msg_To			=	isset($_POST["MsgTo"])		?	$this->Data->escData(trim($_POST["MsgTo"]))			:	false;
		$Msg_Title		=	isset($_POST["MsgTitle"])	?	$this->Data->escData(trim($_POST["MsgTitle"]))		:	false;
		$Msg_Content	=	isset($_POST["MsgContent"])	?	$this->Data->escData(trim($_POST["MsgContent"]))	:	false;
