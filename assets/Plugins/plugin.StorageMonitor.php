<?php
	# Plugin Information
	$this->PLUGIN_NAME			=	"StorageMonitor";
	$this->PLUGIN_MASTERFILE	=	"plugin.StorageMonitor.php";
	$this->PLUGIN_PHP			=	"StorageMonitor.php";
	$this->PLUGIN_AJAX			=	NULL;
	$this->PLUGIN_JS			=	NULL;
	$this->PLUGIN_VERSION		=	"1.0";
	$this->PLUGIN_DATE			=	"11.18.2018";
	...
	elseif($this->MODE == "DISPLAY"){
		$sql	=	("SELECT * FROM ".$this->db->get_TABLE("SETTINGS_PLUGINS")." WHERE PLUGIN_NAME=?");
		$stmt	=	odbc_prepare($this->db->conn,$sql);
