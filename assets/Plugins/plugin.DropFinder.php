<?php
	# Plugin Information
	$this->PLUGIN_NAME			=	'DropFinder';
	$this->PLUGIN_MASTERFILE	=	'plugin.DropFinder.php';
	$this->PLUGIN_PHP			=	'DropFinder.php';
	$this->PLUGIN_AJAX			=	'search.php';
	$this->PLUGIN_JS			=	'plugin_modal.js';
