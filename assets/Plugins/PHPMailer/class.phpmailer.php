	...
	class PHPMailer{
		...
		public function setWordWrap(){
			...
			switch ($this->message_type) {
				...
				case 'alt_inline':
				case 'alt_attach':
				case 'alt_inline_attach': $this->AltBody = $this->wrapText($this->AltBody, $this->WordWrap);break;
		...
		public function encodeString($str, $encoding = 'base64'){
			...
			switch (strtolower($encoding)) {
				...
				case 'quoted-printable': $encoded = $this->encodeQP($str);break;
				default: $this->setError($this->lang('encoding') . $encoding);break;
			}
		...
		public function encodeHeader($str, $position = 'text'){
			...
			switch (strtolower($position)) {
				...
				case 'text':
				default: $matchcount += preg_match_all('/[\000-\010\013\014\016-\037\177-\377]/', $str, $matches);break;
			}
			if ($matchcount == 0) {
				return ($str);
			}
		...
		public static function mb_pathinfo($path, $options = null){
			...
			switch ($options) {
				...
				case 'dirname': return $ret['dirname'];
				case PATHINFO_BASENAME:
				case 'basename': return $ret['basename'];
				case PATHINFO_EXTENSION:
				case 'extension': return $ret['extension'];
				case PATHINFO_FILENAME:
				case 'filename': return $ret['filename'];
				default: return $ret;
			}
		}
